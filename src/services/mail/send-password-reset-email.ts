...
export async function sendPasswordResetEmail({
  ...
  const link = `${env.FRONT_URL}/redefinir-senha?token=${token}`;
  ...
  const condominiumLine = condominiumLabel
    ? `<p style="margin: 0 0 16px;">
        Condomínio: <strong>${condominiumLabel}</strong>
      </p>`
    : "";
                ...
                <tr>
                  <td style="color: #374151; font-size: 14px; line-height: 1.6;">
                    ...
                    <p style="margin: 24px 0 0; font-size: 12px; color: #6b7280;">
                      ...
                      Caso não tenha solicitado a recuperação, ignore este e-mail.
                    </p>
                  </td>
                </tr>
